    ...
    <div class="flex rounded-2xl border-4 border-black bg-white shadow-solid overflow-hidden">
      ...
      <div class="flex-grow p-6">
        ...
        <div class="mt-6 border-t-2 border-black/10 pt-4">
          <a href="/superadmin/ujian" class="inline-flex items-center gap-1.5 rounded-lg border-2 border-black bg-white px-3.5 py-1.5 text-xs font-extrabold uppercase text-black shadow-solid-sm hover:-translate-y-0.5 active:translate-y-0 transition-transform">
